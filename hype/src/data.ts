...
/* All-time power ranking, best (rank 1) to worst (rank 10) — independently
   computed, 2006 title included. score = 2.5*(10 - avgFinish) + 2*titles +
   0.5*top3 finishes: sustained finishing is the spine, titles matter but
   can't fully carry a bad resume. Byrd ranks 3rd with zero rings on pure
   dominance; Lesesne's three titles hold him 5th despite the league's worst
   win%. The video counts DOWN this list (worst first). */
...
export const ALL_TIME: AllTimeRow[] = [
  ...
  { rank: 3, key: "Byrd", manager: "Brian Byrd", record: "142-97", winPct: 0.594, avgFinish: 3.89, pfPerGame: 105.3, titles: [], runnerUps: [2010, 2011, 2012, 2015, 2017], lastPlaces: [2023], top3: 9 },
  ...
  { rank: 6, key: "Omar", manager: "Omar Nagji", record: "131-120-1", winPct: 0.522, avgFinish: 5.47, pfPerGame: 95.9, titles: [2013, 2015], runnerUps: [2020], lastPlaces: [2009, 2012, 2021], top3: 5 },
