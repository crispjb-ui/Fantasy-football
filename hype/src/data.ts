...
export const LOCATIONS: Record<string, { city: string; lat: number; lng: number }> = {
  ...
  Farmer: { city: "Lothian, MD", lat: 38.8032, lng: -76.648 },
  Lesesne: { city: "Atlanta, GA", lat: 33.749, lng: -84.388 },
  Rob: { city: "Martinsburg, WV", lat: 39.4562, lng: -77.9639 },
...
/* Draft venues by August year — the reigning champion picks the room.
   2007-2010: online era, no live draft (2008 Baltimore was semi-official).
   2011 = the FIRST live draft. null city + note = how the pill reads.
...
export const DRAFT_VENUES: {
  ...
  { year: 2007, city: null, note: "ONLINE ERA — NO DRAFT ROOM" },
  { year: 2008, city: "Baltimore, MD", lat: 39.2904, lng: -76.6122, uncertain: true }, // "probably not 100% official"
  { year: 2009, city: null, note: "ONLINE ERA — NO DRAFT ROOM" },
  { year: 2010, city: null, note: "ONLINE ERA — NO DRAFT ROOM" },
  { year: 2011, city: "Las Vegas, NV", lat: 36.1699, lng: -115.1398 }, // THE FIRST LIVE DRAFT
  ...
  { year: 2016, city: null, note: "SITE LOST TO HISTORY" },
...
export const VENUE_PHOTOS: Record<number, string[]> = {
  ...
  2025: [
    ...
    "2025-1.jpg",
  ], // Bozeman — rodeo, drift boat, riverside
};
...
/* All-time power ranking, best (rank 1) to worst (rank 10) — independently
   computed, 2006 title included, using Brett's approved original weights:
   score = 2*(10 - avgFinish) + 3*titles + 0.5*top3 finishes. Titles are what
   the league plays for; Lesesne's three rings carry him to 3rd, Byrd's
   ringless dominance lands 6th. The video counts DOWN this list. */
